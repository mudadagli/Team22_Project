...
public class TC04 extends TestBaseReport {
    ...
    public void test01() throws InterruptedException {
        extentTest=extentReports.createTest("Pozitif Test","Tipi ve sebebi aciklanmali");
        ...
        //Type bolumunun gorunur oldugunu dogrular
        Assert.assertTrue(eyupPage.vendorTypeText.isDisplayed());
        extentTest.info("Type bolumunun gorunur oldugunu dogrulandi");

        //Reason bolumunun gorunur oldugunu dogrular
        Assert.assertTrue(eyupPage.vendorReasonText.isDisplayed());
        extentTest.info("Reasont bolumunun gorunur oldugunu dogrulandi");
