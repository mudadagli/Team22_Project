...
public class TC03 extends TestBaseReport {
    ...
    public void test01() throws InterruptedException {
        extentTest=extentReports.createTest("Pozitif Test","Ne kadar urun alindigi belli edilmeli");
        ...
        //Amount bolumunun gorunur oldugunu dogrular
        Assert.assertTrue(eyupPage.vendorAmountText.isDisplayed());
        extentTest.info("Amount bolumunun gorunur oldugunu dogrulandi");
