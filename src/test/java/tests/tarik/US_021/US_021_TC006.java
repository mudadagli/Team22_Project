...
public class US_021_TC006 extends TestBaseReport {
   ...
   10. Custom kutucuğundan özel bir tarih aralığı seçilir
   11. Seçilen tarih aralığının raporunun görüntülendiği doğrulanır
     */
    ...
    public void test01() {
        extentTest = extentReports.createTest("Satış Raporlarının İncelebilmesi Testi",
                "Seçilen tarih aralığının raporu görüntülendi");
