...
public class US_021_TC003 extends TestBaseReport {
     /*
   ...
   10. This Month sekmesine tıklanır ve ilgili raporun göründüğü doğrulanır
     */
    ...
    public void test01() {
        extentTest = extentReports.createTest("Satış Raporlarının İncelebilmesi Testi",
                "İçinde bulunulan ayın raporu incelendi");
