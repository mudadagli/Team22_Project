...
public class US_019_TC002 extends TestBaseReport {
    ...
    10. İşlemlerin Actions başlığı altında tanımlandığı doğrulanır
    */
    ...
    @Test
    public void test01() {
        extentTest = extentReports.createTest("Takipçi Testi", "İşlemler Tanımlanamadı");
