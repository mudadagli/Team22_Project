...
public class US006_006 extends TestBaseReport {
    ...
    public void test006_006() {
        ...
        muhammedPage.categoryNameBox.sendKeys("Books & Music & Film ");
        ...
        jse.executeScript("arguments[0].scrollIntoView(true);", muhammedPage.booksMusicFilmClickButton);
        jse.executeScript("arguments[0].click();", muhammedPage.booksMusicFilmClickButton);

        Assert.assertTrue(muhammedPage.booksMusicFilmClickButton.isSelected());
        extentTest.info("Books & Music & Film urunler butonuna tiklama yapildi");
    }
