...
public class US006_008 extends TestBaseReport {
    ...
    public void test006_008() {
        ...
        muhammedPage.categoryNameBox.sendKeys("moda&giyim");
        ...
        jse.executeScript("arguments[0].scrollIntoView(true);", muhammedPage.modaGiyimClickButton);
        jse.executeScript("arguments[0].click();", muhammedPage.modaGiyimClickButton);

        Assert.assertTrue(muhammedPage.modaGiyimClickButton.isSelected());
        extentTest.info("Moda & giyim urunler butonuna tiklama yapildi");
