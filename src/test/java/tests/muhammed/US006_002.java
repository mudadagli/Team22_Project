...
public class US006_002 extends TestBaseReport {
    ...
    public void test006_02() {
        ...
        muhammedPage.categoryNameBox.sendKeys("Best Seller");
        ...
        jse.executeScript("arguments[0].scrollIntoView(true);", muhammedPage.bestsellerClickButton);
        jse.executeScript("arguments[0].click();", muhammedPage.bestsellerClickButton);
        Assert.assertTrue(muhammedPage.bestsellerClickButton.isSelected());
