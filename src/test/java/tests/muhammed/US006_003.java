...
public class US006_003 extends TestBaseReport {
        ...
        public void test006_03() {
                ...
                muhammedPage.categoryNameBox.sendKeys("electronics");
                ...
                jse.executeScript("arguments[0].scrollIntoView(true);", muhammedPage.electronicsClickButton);
                jse.executeScript("arguments[0].click();", muhammedPage.electronicsClickButton);

                Assert.assertTrue(muhammedPage.electronicsClickButton.isSelected());
                extentTest.info("Electronis butonuna tiklama yapildi");
        }
