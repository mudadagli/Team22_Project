...
public class US006_007 extends TestBaseReport {
    ...
    public void test006_007() {
        ...
        muhammedPage.categoryNameBox.sendKeys("Kozmetik");
        ...
        jse.executeScript("arguments[0].scrollIntoView(true);", muhammedPage.kozmetikClickButton);
        jse.executeScript("arguments[0].click();", muhammedPage.kozmetikClickButton);

        Assert.assertTrue(muhammedPage.kozmetikClickButton.isSelected());
        extentTest.info("Kozmetik urunler butonuna tiklama yapildi");
    }
