...
public class US006_011 extends TestBaseReport {
    ...
    public void test006_011() {
        ...
        muhammedPage.categoryNameBox.sendKeys("Yeni Urunler");
        ...
        jse.executeScript("arguments[0].scrollIntoView(true);", muhammedPage.yeniUrunlerClickButton);
        jse.executeScript("arguments[0].click();", muhammedPage.yeniUrunlerClickButton);
        Assert.assertTrue(muhammedPage.yeniUrunlerClickButton.isSelected());
