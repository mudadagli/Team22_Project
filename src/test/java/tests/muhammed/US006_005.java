...
public class US006_005 extends TestBaseReport {
    ...
    public void test006_005() {
        ...
        muhammedPage.categoryNameBox.sendKeys("İndirimli ürünler");
        ...
        jse.executeScript("arguments[0].scrollIntoView(true);", muhammedPage.indirimliUrunlerClickButton);
        jse.executeScript("arguments[0].click();", muhammedPage.indirimliUrunlerClickButton);

        Assert.assertTrue(muhammedPage.indirimliUrunlerClickButton.isSelected());
        extentTest.info("Indirimli urunler butonuna tiklama yapildi");
    }
