...
public class US006_009 extends TestBaseReport {
    ...
    public void test006_009() {
        ...
        muhammedPage.categoryNameBox.sendKeys("Toys & Games");
        ...
        jse.executeScript("arguments[0].scrollIntoView(true);", muhammedPage.oyuncakClickButton);
        jse.executeScript("arguments[0].click();", muhammedPage.oyuncakClickButton);

        Assert.assertTrue(muhammedPage.oyuncakClickButton.isSelected());
        extentTest.info("Toys & Games  urunler butonuna tiklama yapildi");
    }
